...
if user_choice == '1':
	...
	session = ConnectHandler(device_type = 'cisco_xe', ip = ip, username = username, password = password)
	...
	if user_choice == '1':
		...
		filename = raw_input('\nPlease name your file. Example: /home/ubuntu/xe1.txt: ')
...
#For using this application on other networking vendors, just replace device_type = 'cisco_xe' with any of the following:
