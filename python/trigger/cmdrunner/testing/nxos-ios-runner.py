    ...
    try:
        for device in ios_devices:
            ...
            with open('IOS-Results.txt', 'w') as ios_file:
                ...
                print(connection.send_config_set(ios_commands))
                ios_file.write(connection.send_config_set(ios_commands))
                ios_file.write(connection.send_command('write memory'))
        ...
        for device in nxos_devices:
            ...
            with open('NXOS-Results.txt', 'w') as nxos_file:
                ...
                print(connection.send_config_set(nxos_commands))
                nxos_file.write(connection.send_config_set(nxos_commands))
                nxos_file.write(connection.send_command('copy run start'))
                connection.disconnect()
                print('~'*79 + '\n\n')
                nxos_file.write('~'*79 + '\n\n')
