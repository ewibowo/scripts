...
cd ~/.dotfiles
git pull
#git clone https://github.com/rlaneyjr/dotfiles.git 

cd ~/.vim
git pull
#git clone https://github.com/rlaneyjr/vim.git 

cd ~/.zsh
git pull
#git clone https://github.com/rlaneyjr/zsh.git 

cd ~/lib
git pull
#git clone https://github.com/rlaneyjr/lib.git 

cd ~/.zplug
git pull
#git clone https://github.com/rlaneyjr/zplug.git 

cd ~/.config
git pull
#git clone https://github.com/rlaneyjr/config.git 

cd ~/.tmux
git pull
#git clone https://github.com/rlaneyjr/tmux.git 

cd ~/.tmuxinator
git pull
#git clone https://github.com/rlaneyjr/tmuxinator.git 


export $HOME/scripts/bin/linkBatch.sh
export $HOME/scripts/bin/linkdots.sh
