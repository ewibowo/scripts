...
#PREFIX = '/etc/trigger'
PREFIX = '/Users/rlaney/Projects/NetEngineerONE/neteng/trigger'

# The root where data files are stored.
DATA = os.getenv('DATA', os.path.join(os.path.dirname(PREFIX), 'data'))
...
STARTUP_COMMANDS_MAP = {
    ...
    'riverbed': STARTUP_COMMANDS_DEFAULT,
}
...
GORC_FILE = os.getenv('GORC_FILE', os.path.join(PREFIX, '.gorc'))
